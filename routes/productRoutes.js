...
router.post('/',verifyToken,isAdmin ,checkSchema(createProductSchema), handleValidationErrors,productController.createProduct);
router.post('/many',
    verifyToken ,isAdmin ,[// Đây cũng là 1 cách để validate dữ liệu đầu vào
